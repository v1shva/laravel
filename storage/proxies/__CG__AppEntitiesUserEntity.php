 ...
 */
class UserEntity extends \App\Entities\UserEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\UserEntity' . "\0" . 'id', '' . "\0" . 'App\\Entities\\UserEntity' . "\0" . 'name', '' . "\0" . 'App\\Entities\\UserEntity' . "\0" . 'email', '' . "\0" . 'App\\Entities\\UserEntity' . "\0" . 'userlevel', 'password', 'rememberToken'];
        }
